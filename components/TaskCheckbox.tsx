...
const TaskCheckbox = ({ task, checked, onChange }: Props & CheckboxProps) => {
  ...
  return (
    <Field
      ...
      className="bg-gray-medium dark:bg-black-medium cursor-pointer flex items-center rounded px-4 py-3 gap-3 hover:bg-purple-dark/25"
    >
      <Checkbox
        checked={checked}
      ...
      <Label
        className={`text-bodyM text-black-dark dark:text-white select-none ${checked ? "line-through text-gray-dark" : ""}`}
      >
        {task}
      </Label>
    </Field>
